...
fig,ax1=st.plot(FAC_A[0].values,abs(FAC_A[6].values),legends=[FAC_A[6].name+'_A mean'])

#%% mean_test

mean_test = my.orbit_means_fac(FAC_A[0],FAC_A[1],FAC_A[6],'simple')
...
mean_test = my.orbit_means_fac(FAC_A[0],FAC_A[1],FAC_A[6],'abs')


fig,ax1=st.plot(mean_test[0],mean_test[1],legends=[FAC_A[6].name+'_A abs'])
#%%
mean_test = my.orbit_means_fac(FAC_A[0],FAC_A[1],FAC_A[6],'power')
#%%
...
mean_test = my.orbit_means_fac(FAC_C[0],FAC_C[1],FAC_C[6],'simple')
